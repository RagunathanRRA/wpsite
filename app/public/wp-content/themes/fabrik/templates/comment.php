		...
		<div class="comment-content">
			<div class="comment-meta">
				...
				<div class="comment-meta-inner comment-meta-right">
					<?php edit_comment_link( sprintf( '[%s]', esc_html__( 'Edit', 'fabrik' ) ) ) ?>
				</div>
			</div>
			<?php if ( $comment->comment_approved == '0' ) : ?>
				<span class='unapproved'><?php esc_html_e( 'Your comment is awaiting moderation.', 'fabrik' ); ?></span>
			<?php endif ?>
				...
				<?php
					if ( $args['type'] == 'all' || get_comment_type() == 'comment' ) :
						comment_reply_link( array_merge( $args, array(
							'reply_text' => '<span class="btext">' . esc_html__( 'Reply', 'fabrik' ) . '</span>',
							'login_text' => '<span class="btext">' . esc_html__( 'Log in to reply.', 'fabrik' ) . '</span>',
							'depth'      => $depth,
