...
<div class="page-wrapper">
	...
	<article class="<?php echo esc_attr( VamtamTemplates::get_layout() ) ?>">
		<div class="page-content clearfix">
			<?php if ( ! empty( $description ) ) : ?>
				<div class="author-info-box clearfix">
					...
					<div class="author-description">
						<h4><?php echo esc_html( sprintf( __( 'About %s', 'fabrik' ), $author->data->display_name ) ); ?></h4>
			...
			<?php else : ?>
				<h2 class="no-posts-by-author"><?php sprintf( esc_html__( '%s has not published any posts yet', 'fabrik' ), $author->data->display_name ) ?></h2>
			<?php endif ?>
		</div>
	</article>
