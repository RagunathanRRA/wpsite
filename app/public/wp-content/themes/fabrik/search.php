...
VamtamFramework::set( 'page_title', sprintf( esc_html__( 'Search Results for: %s', 'fabrik' ), '<span>' . get_search_query() . '</span>' ) );
...
<div class="page-wrapper">
	...
	<article id="vamtam-no-search-results">
		...
		<h3><?php esc_html_e( 'Sorry, nothing found', 'fabrik' ) ?></h3>

		<div><?php esc_html_e( 'Maybe you should check your spelling...', 'fabrik' ) ?></div>
