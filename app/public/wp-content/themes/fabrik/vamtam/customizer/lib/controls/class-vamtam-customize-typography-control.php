...
class Vamtam_Customize_Typography_Control extends Vamtam_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['l10n'] = array(
			'font-family'                => esc_html__( 'Font Family', 'fabrik' ),
			'select-font-family'         => esc_html__( 'Select Font Family', 'fabrik' ),
			'font-weight'                     => esc_html__( 'Weight', 'fabrik' ),
			'transform'                  => array (
				'label'        => esc_html__( 'Transform', 'fabrik' ),
				'uppercase'    => esc_html__( 'Uppercase', 'fabrik' ),
				'lowercase'    => esc_html__( 'Lowercase', 'fabrik' ),
				'capitalize'   => esc_html__( 'Capitalize', 'fabrik' ),
				'normal'       => esc_html__( 'Normal', 'fabrik' ),
			),
			'font-style'                 => array (
				'label'        => esc_html__( 'Style', 'fabrik' ),
				'normal'       => esc_html__( 'Normal', 'fabrik' ),
				'italic'       => esc_html__( 'Italic', 'fabrik' ),
				'oblique'      => esc_html__( 'Oblique', 'fabrik' ),
			),
			'decoration'                 => array (
				'label'        => esc_html__( 'Decoration', 'fabrik' ),
				'underline'    => esc_html__( 'Underline', 'fabrik' ),
				'overline'     => esc_html__( 'Overline', 'fabrik' ),
				'line-through' => esc_html__( 'Line Through', 'fabrik' ),
				'none'         => esc_html__( 'None', 'fabrik' ),
			),
			'font-size'                  => esc_html__( 'Font Size', 'fabrik' ),
			'line-height'                => esc_html__( 'Line Height', 'fabrik' ),
			'color'                      => esc_html__( 'Font Color', 'fabrik' ),
			'letter-spacing'             => esc_html__( 'Letter Spacing', 'fabrik' ),
			'letter-spacing-description' => wp_kses( __( 'Either <code>normal</code> or a length unit', 'fabrik' ), [ 'code' => [] ] ),
		);
	}
	/**
