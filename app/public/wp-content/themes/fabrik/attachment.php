...
VamtamFramework::set( 'page_title', esc_html__( 'Attachment', 'fabrik' ) );
	...
	<div class="page-wrapper">
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class( VamtamTemplates::get_layout() ); ?>>
			<div class="page-content clearfix">
				...
				<div class="entry-caption">
					...
					<?php
						if ( wp_attachment_is_image() ) {
							...
							printf( esc_html__( 'Original size is %s pixels', 'fabrik' ),
								sprintf( '<a href="%1$s" title="%2$s">%3$s &times; %4$s</a>',
									esc_url( wp_get_attachment_url() ),
									esc_attr__( 'Link to full-size image', 'fabrik' ),
				...
				<?php the_content( wp_kses( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'fabrik' ), 'vamtam-a-span' ) ); ?>
