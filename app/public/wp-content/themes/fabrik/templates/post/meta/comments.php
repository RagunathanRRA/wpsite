...
<?php if ( $show ) : ?>
	<div class="comment-count vamtam-meta-comments">
		<?php
			comments_popup_link(
				$comment_icon . wp_kses( __( '0 <span class="comment-word ">Comments</span>', 'fabrik' ), 'vamtam-a-span' ),
				$comment_icon . wp_kses( __( '1 <span class="comment-word ">Comment</span>', 'fabrik' ), 'vamtam-a-span' ),
				$comment_icon . wp_kses( __( '% <span class="comment-word ">Comments</span>', 'fabrik' ), 'vamtam-a-span' )
			);
		?>
	</div>
<?php endif; ?>
