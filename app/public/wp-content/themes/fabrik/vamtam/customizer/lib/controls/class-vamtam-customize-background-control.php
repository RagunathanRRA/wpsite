...
class Vamtam_Customize_Background_Control extends Vamtam_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->button_labels = wp_parse_args( $this->button_labels, array(
			'select'       => esc_html__( 'Select Image', 'fabrik' ),
			'change'       => esc_html__( 'Change Image', 'fabrik' ),
			'remove'       => esc_html__( 'Remove', 'fabrik' ),
			'default'      => esc_html__( 'Default', 'fabrik' ),
			'placeholder'  => esc_html__( 'No image selected', 'fabrik' ),
			'frame_title'  => esc_html__( 'Select Image', 'fabrik' ),
			'frame_button' => esc_html__( 'Choose Image', 'fabrik' ),
		) );
		...
		self::$selects = array(
			'background-repeat' => array(
				'no-repeat' => esc_html__( 'No repeat', 'fabrik' ),
				'repeat-x'  => esc_html__( 'Repeat horizontally', 'fabrik' ),
				'repeat-y'  => esc_html__( 'Repeat vertically', 'fabrik' ),
				'repeat'    => esc_html__( 'Repeat both', 'fabrik' ),
			),
			'background-attachment' => array(
				'scroll' => esc_html__( 'scroll', 'fabrik' ),
				'fixed'  => esc_html__( 'fixed', 'fabrik' ),
			),
			'background-size' => array(
				'auto'    => esc_html__( 'auto', 'fabrik' ),
				'cover'   => esc_html__( 'cover', 'fabrik' ),
				'contain' => esc_html__( 'contain', 'fabrik' ),
			),
			'background-position' => array(
				'left top'      => esc_html__( 'left top', 'fabrik' ),
				'left center'   => esc_html__( 'left center', 'fabrik' ),
				'left bottom'   => esc_html__( 'left bottom', 'fabrik' ),
				'center top'    => esc_html__( 'center top', 'fabrik' ),
				'center center' => esc_html__( 'center center', 'fabrik' ),
				'center bottom' => esc_html__( 'center bottom', 'fabrik' ),
				'right top'     => esc_html__( 'right top', 'fabrik' ),
				'right center'  => esc_html__( 'right center', 'fabrik' ),
				'right bottom'  => esc_html__( 'right bottom', 'fabrik' ),
			),
		);
	}
	...
	public function to_json() {
		...
		$this->json['alt_medium']    = esc_html__( 'Medium-sized attachment', 'fabrik' );
		$this->json['alt_full']      = esc_html__( 'Full-sized attachment', 'fabrik' );

		$this->json['option_labels'] = array(
			'background-type'       => esc_html__( 'Background Type', 'fabrik' ),
			'background-repeat'     => esc_html__( 'Repeat', 'fabrik' ),
			'background-image'      => esc_html__( 'Image', 'fabrik' ),
			'background-attachment' => esc_html__( 'Attachment', 'fabrik' ),
			'background-size'       => esc_html__( 'Size', 'fabrik' ),
			'background-position'   => esc_html__( 'Position', 'fabrik' ),
			'background-color'      => esc_html__( 'Color', 'fabrik' ),
			'background-gradient'   => [
				'color-1'              => esc_html__( 'Color 1', 'fabrik' ),
				'color-2'              => esc_html__( 'Color 2', 'fabrik' ),
				'location'             => esc_html__( 'Location', 'fabrik' ),
				'type'                 => esc_html__( 'Type', 'fabrik' ),
				'position'             => esc_html__( 'Position', 'fabrik' ),
				'angle'                => esc_html__( 'Angle', 'fabrik' ),
			],
		);
		...
		$this->json['l10n'] = array(
			'background-gradient'   => [
				'type'              => [
					'linear' => esc_html__( 'Linear', 'fabrik' ),
					'radial' => esc_html__( 'Radial', 'fabrik' ),
				],
				'position'          => [
					'center center' =>  esc_html__( 'Center Center' , 'fabrik' ),
					'center left'   =>  esc_html__( 'Center Left' , 'fabrik' ),
					'center right'  =>  esc_html__( 'Center Right' , 'fabrik' ),
					'top center'    =>  esc_html__( 'Top Center' , 'fabrik' ),
					'top left'      =>  esc_html__( 'Top Left' , 'fabrik' ),
					'top right'     =>  esc_html__( 'Top Right' , 'fabrik' ),
					'bottom center' =>  esc_html__( 'Bottom Center' , 'fabrik' ),
					'bottom left'   =>  esc_html__( 'Bottom Left' , 'fabrik' ),
					'bottom right'  =>  esc_html__( 'Bottom Right' , 'fabrik' ),
				],
			],
		);
